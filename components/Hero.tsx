	...
	return (
		<section className='flex flex-col md:flex-row justify-between items-center space-y-10 mt-12 sm:mt-24  '>
            ...
            https://drive.google.com/file/d/15fX3oftYQfbOtfpLOliO0rV4CB0YIgrz/view?usp=sharing'
					...
					target='_blank'
					className='bg-blue-600 sm:inline-block mt-2 mr-2 hover:bg-blue-700 text-white shadow-inner px-6 py-3 rounded-md border-2 border-blue-600 hover:border-blue-700 text-lg sm:text-xl focus:outline-none focus:ring-4 focus:ring-blue-600 focus:ring-opacity-50 whitespace-nowrap '>
					View Resume
				</a>
				<a
					href='mailto:oubaniayoub@gmail.com'
					className='bg-gray-600 sm:inline-block mt-2 hover:bg-gray-400 text-white px-8 py-3 rounded-md border-0 text-lg sm:text-xl '>
					Contact Me
				</a>
			</div>
